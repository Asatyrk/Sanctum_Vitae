/* =========================================================
   MONSTROUS COMPENDIUM PROFILE LOADER
   ========================================================= */
...
async function loadMonstrousCompendium(){
  ...
  try{
    ...
    const speciesPath =
      `monstrous_compendium/${slug}.json`
...
function displayMonstrousCompendium(
  species
){
