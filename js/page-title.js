document.addEventListener("DOMContentLoaded", () => {
  ...
  const titleIcons = {
    home: `
      <svg viewBox="0 0 640 640" aria-hidden="true" focusable="false" class="page-title-icon">
  ...
  function renderPageTitle() {
    ...
    const iconHtml = titleIcons[normalizedPage] || "";
    titleEl.innerHTML = `${iconHtml}<span>${pageName}</span>`;
  }
